...
from ..encoder_eloftr import EncoderELoFTR
# from ..epipolar.epipolar_sampler import EpipolarSampling
from .encoder_visualizer import EncoderVisualizer
from .encoder_visualizer_eloftr_cfg import EncoderVisualizerELoftrCfg
...
class EncoderVisualizerELoFTR(
    EncoderVisualizer[EncoderVisualizerELoftrCfg, EncoderELoFTR]
):
    def visualize(
        self,
