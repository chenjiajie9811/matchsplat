...
from .model_wrapper import OptimizerCfg, TestCfg, TrainCfg
...
class ModelWrapper(LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # self.writer.add_histogram("train/weights_mconf", batch["mconf"], self.global_step)
        # self.writer.add_histogram("train/weights_mconf_before", batch["mconf_before"], self.global_step)
        ...
        # gt pose supervision
        # total_loss = total_loss + 0.05 * batch["rot_err_rel"] + 0.05 * batch["trans_err_rel"]
