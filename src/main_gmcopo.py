...
with install_import_hook(
    ...
    from src.model.model_wrapper_copo import ModelWrapper
...
def train(cfg_dict: DictConfig):
    ...
    # encoder_ckpt_path = "outputs/copo/checkpoints/epoch_449-step_9000.ckpt"
    # model_wrapper.load_state_dict(torch.load(encoder_ckpt_path)['state_dict'], strict=True)
